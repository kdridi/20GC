...
{
    SDL_SetAppMetadata("20GC: Pong", "0.1", "com.kdridi.20gc.games.pong");
    ...
    if (!SDL_CreateWindowAndRenderer("20GC: Pong", WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_RESIZABLE, &window, &renderer)) {
