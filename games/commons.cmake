...
function(tgc_add_game)
  if(ARGC GREATER 0)
    message(FATAL_ERROR "tgc_add_game() does not accept arguments")
  endif()
  ...
  if(NOT common_sources AND NOT platform_sources)
    message(FATAL_ERROR
      "Game '${target_name}' has no C++ source for platform '${CMAKE_SYSTEM_NAME}'"
    )
  endif()

  add_executable("${target_name}")
  set(TGC_GAME_TARGET "${target_name}")
  set(TGC_GAME_TARGET "${target_name}" PARENT_SCOPE)
